...
## [#](https://easyhexo.com/3-Plugins-use-and-config/3-2-hexo-tag-dplayer/#安装)安装
...
## [#](https://easyhexo.com/3-Plugins-use-and-config/3-2-hexo-tag-dplayer/#使用)使用
...
附 Dplayer 一些简单的参数列表，注意， Dplayer 的参数仅作为参考，具体请以 [hexo-tag-dplayer](https://github.com/MoePlayer/hexo-tag-dplayer) 为准
...
## [#](https://easyhexo.com/3-Plugins-use-and-config/3-2-hexo-tag-dplayer/#使用弹幕)使用弹幕
...
## [#](https://easyhexo.com/3-Plugins-use-and-config/3-2-hexo-tag-dplayer/#使用字幕)使用字幕
